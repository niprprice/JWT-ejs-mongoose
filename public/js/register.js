...
btn1.addEventListener("click", function(){
    if(document.getElementById("username-signUp").value == ""){
        ...
        request.open("POST", "https://creepy-moonlight-79600.herokuapp.com/register/signup");
...
btn2.addEventListener("click", function(){
    if(document.getElementById("email-signIn").value == ""){
        ...
        request.open("POST", "https://creepy-moonlight-79600.herokuapp.com/register/signin");
        request.setRequestHeader("Content-type", "application/json");
